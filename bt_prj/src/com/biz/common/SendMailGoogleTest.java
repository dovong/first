...
public class SendMailGoogleTest{
	//youdontneedtoknowmypassword
	private final String HOST = "smtp.gmail.com";
	private final String HOST_ID = "kdyn001@gmail.com";
	private final String HOST_PW = "rlaehdbs87";
	...
	public void sendMail(String to, String subject, String body){
		...
		try{
			...
			//String htmlStr = "<font color='red'>dddddddddddd</font>";
			message.setContent(body, "text/html"); //html로 보내기
			//message.setText(htmlStr); //문장으로 보내기
