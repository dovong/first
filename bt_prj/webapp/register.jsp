...
$(document).ready(function(){
	...
	//jQuery 지원 : 첨부파일 미리보기 ---------------------
	$("#pname").on("change", myFilePreviewFunction); // 동적바인딩 ("#**").on("****", function) 
 	
	function myFilePreviewFunction(e) {
			$("#prev-img-div").empty(); //remove는 div자체를 지워버림, 값만 지울때는 div
			var files = e.target.files;  //파일 읽어들임			//[object FileList]
			//FileList into an array
			//var fileArr = Array.prototype.slice.call(files); //Array.from과 같은 문법		
			...
			fileArr.forEach(function(f) {
					...
					var htmlStr = "";
					reader.onload = function(e) {  //속성을 불러옴
					...
					//} 
					reader.readAsDataURL(f); //이미지 불러옴
			});
...
<!-- 프로필사진 올리는 div -->
                  ...
                  -->
				   ...
				   <div class="form-group" style="line-height:220%">
				    ...
				    <label for="postcodify_15420022227240317" style="display: none;">검색 키워드</label>
				    <input type="text" class="keyword" value="" id="postcodify_15420022227240317" style="width: 550px;">
				    <button type="button" class="search_button" id="postcodify_15420022227240317_button">검색</button></div> -->
				    ...
				    <div class="too_short postcodify_search_status postcode_search_status">검색어는 3글자 이상 입력해 주십시오.</div>
				     ...
				     <input type="text" id="addr" class="form-control" value="" style="width: 550px;">
				     <br>
				     <label for="ex2_input2">상세주소</label>
				    <input type="text" id="addr_detail" class="form-control" value="" style="width: 550px;">
				    <br>
				    <label for="ex2_input3">참고항목</label>
				    <input type="text" id="addr_etc" class="form-control" value="" style="width: 550px;">
				    <br>
				    <label for="ex2_input4">지번주소</label>
				    <input type="text" id="addr_jibun" class="form-control" value="" style="width: 550px;">
				    <br>
				    <label for="ex2_input5">영문주소</label>
				    <input type="text" id="addr_eng" class="form-control" value="" style="width: 550px;">
				    <br>
				</div>
